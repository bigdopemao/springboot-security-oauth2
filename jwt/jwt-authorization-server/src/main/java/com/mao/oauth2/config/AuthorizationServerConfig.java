...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter() {
        ...
        // setSigningKey 和 setKeyPair 二选一
//        converter.setSigningKey("my-sign-key"); // 密钥，默认是HMACSHA256对称加密
        KeyStoreKeyFactory storeKeyFactory = new KeyStoreKeyFactory(new ClassPathResource("test.jks"), "mypass".toCharArray());
        converter.setKeyPair(storeKeyFactory.getKeyPair("mytest"));
        return converter;
    }
}
